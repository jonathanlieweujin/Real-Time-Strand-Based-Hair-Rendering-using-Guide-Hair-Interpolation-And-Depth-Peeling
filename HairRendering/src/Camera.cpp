...
Camera::Camera(float zoom,  glm::mat4 projection, float angleX, float angleY)
{
	...
	mView = glm::translate(glm::vec3(-2.0f, 0.0f, -mZoom)) * glm::rotate(mAngleY, glm::vec3(1.0f, 0.0f, 0.0f)) * glm::rotate(mAngleX, glm::vec3(0.0f, 1.0f, 0.0f));
...
glm::vec3 Camera::GetPosition() const {
	glm::mat4 inverseViewMatrix = glm::inverse(mView);
	glm::vec3 cameraPosition = glm::vec3(inverseViewMatrix[3]);  // Extract the translation component
